<template>
    ...
    <div v-else class="max-w-6xl mx-auto gap-6">
        ...
        <div class="flex items-center justify-between pb-4">
            <div>
                <h1 class="text-2xl font-bold text-white">Order #{{ order.orderNumber }}</h1>
                <p class="text-[var(--color-icon)]">Placed on {{ formatDate(order.createdAt) }}</p>
            </div>
            ...
            <div class="flex items-center gap-3">
                ...
                <button
                @click="printInvoice"
                class="flex items-center gap-2 border border-[var(--color-border)] text-[var(--color-icon)] rounded-lg px-4 py-2 hover:bg-[var(--color-hover)]"
                >
        ...
        <Card class="p-4 border border-[var(--color-border)]">
            <h2 class="text-lg font-semibold mb-4 text-white">Order Status</h2>
